    ...
    <div className='flex items-center justify-between px-4'>
      ...
      >
        ...
        <Link href='/about'><span className={isActive('/about')}>About</span></Link>
          ...
          <Link href='/matches'><span className={isActive('/matches')}>About</span></Link>
          <Link href='/faqs'><span className={isActive('/faqs')}>Profile</span></Link>
          <Link href='/sign-up'><span className={isActive('/sign-up')}>Find Players</span></Link>
