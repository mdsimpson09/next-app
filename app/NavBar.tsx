  ...
  return (
    ...
    <div className='flex items-center justify-between px-4'>
      ...
      >
        ...
        {/* Navigation Links */}
        <div className={`flex-1 md:flex md:items-center md:justify-between absolute md:relative right-0 top-16 md:top-0 w-full md:w-auto bg-indigo-400 md:bg-transparent p-4 md:p-0 transition-all duration-300 ease-in-out ${isMenuOpen ? 'block' : 'hidden'} ml-12`}>
          <Link href='/about'><span className={`${isActive('/about')}  hover:outline p-3 rounded-md shadow-outline`}>About</span></Link>
          <Link href='/profile'><span className={`${isActive('/profile')}  p-3 hover:outline rounded-md shadow-outline`}>Profile</span></Link>
          <Link href='/meet'><span className={`${isActive('/meet')} p-3 hover:outline rounded-md shadow-outline`}>Find Players</span></Link>
          <Link href='/matches'><span className={`${isActive('/matches')} p-3 hover:outline rounded-md shadow-outline`}>Your Matches</span></Link>
          <Link href='/faqs'><span className={`${isActive('/faqs')} p-3 hover:outline rounded-md shadow-outline`}>FAQs</span></Link>
          <Link href='/sign-up'><span className={`${isActive('/sign-up')} p-3 hover:outline rounded-md shadow-outline`}>Sign Up</span></Link>
